# A Terraform module to create "application" type of environment with kops-managed Kubernetes.
...
* Kubernetes cluster, deployed using kops
...
```hcl
module "application" {                                                          
  source = "github.com/kentrikos/terraform-aws-account-application-kops"
